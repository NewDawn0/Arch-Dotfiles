...
static int incremental = d0;       /* -r  option; if 1, outputs text each time a key is pressed */
...
static unsigned int lineheight = 30;         /* -h option; minimum height of a menu line    default 22 */
static unsigned int min_lineheight = 15;	//default 8
